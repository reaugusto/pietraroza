...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        // Limpa a nav e as seções estáticas se quisermos montar dinamicamente (opcional)
        // Mas para garantir compatibilidade, vamos gerar se não existir e também gerar a nav
        ...
        categories.forEach((cat, index) => {
            ...
            const items = works.filter(w => w.category_id === cat.id);
        ...
        console.error('Error loading works gallery data:', err);
    }
});
